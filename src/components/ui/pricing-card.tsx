...
const PricingComponent: React.FC<PricingComponentProps> = ({
    ...
    const maxAnnualDiscount = 10; // Max plan gets 10% off annually
...
const examplePlans: [PriceTier, PriceTier, PriceTier] = [
    {
        ...
        priceMonthly: 12,
        priceAnnually: 144, // 12 * 12
        isPopular: false,
        buttonLabel: 'Start with Go',
        features: [
            { name: '2 Projects', isIncluded: true },
            { name: 'Advanced Analysis (Limited)', isIncluded: true },
            { name: 'Higher Rate Limits', isIncluded: true },
            { name: 'Operator Lite', isIncluded: true },
            { name: 'Emailing Support', isIncluded: true },
            { name: 'Website Builder', isIncluded: false },
        ],
    },
    {
        id: 'pro',
        ...
        priceMonthly: 30,
        priceAnnually: 360, // 30 * 12
        isPopular: true,
        buttonLabel: 'Get Pro',
        features: [
            { name: '5 Projects', isIncluded: true },
            { name: 'Unlimited Advanced Analysis', isIncluded: true },
            { name: 'Operator', isIncluded: true },
            { name: 'Emailing Support', isIncluded: true },
            { name: 'Limited Website Builder', isIncluded: true },
            { name: 'Pro Image Generation', isIncluded: true },
            { name: '30 Video Generations/day', isIncluded: true },
        ],
    },
    {
        id: 'max',
        name: 'Max',
        description: 'The ultimate power suite for high-scale organizations.',
        priceMonthly: 120,
        priceAnnually: 1296, // 120 * 12 * 0.9 (10% off)
        isPopular: false,
        buttonLabel: 'Upgrade to Max',
        features: [
            { name: 'Unlimited Projects', isIncluded: true },
            { name: 'Unlimited Max Analysis', isIncluded: true },
            { name: 'Operator Pro', isIncluded: true },
            { name: 'Bulk Emailing Support', isIncluded: true },
            { name: 'Website Builder (Unlimited)', isIncluded: true },
            { name: 'Pro Image Generation (Fast)', isIncluded: true },
            { name: 'Unlimited Video Generations/day', isIncluded: true },
        ],
    },
];
